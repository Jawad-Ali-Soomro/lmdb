  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="relative h-[100vh] flex items-end">
        ...
        <div className="relative z-10 pl-20  pb-20 flex gap-10 items-end">
          {actorDetails.profile_path && (
            <img
          ...
          <div className="flex-1 text-white">
            <h1 className="text-5xl font-black mb-4">{actorDetails.name}</h1>
            
            {actorDetails.birthday && (
              <div className="mb-4">
                <p className="text-xl flex items-center gap-2 text-white/80">
                <MdLocationPin />
            ...
            {actorDetails.biography && (
              <div className="mb-6">
                <h2 className="text-2xl font-black mb-3">Biography</h2>
                <p className="text-lg text-white/90 leading-relaxed max-w-3xl text-justify">
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              {actorDetails.popularity && (
                <div className="px-4 py-2 flex items-center gap-2 bg-white/20 rounded-full font-bold">
      ...
      {actorMovies.length > 0 && (
        <div className="px-20 mt-20">
          ...
          <div className="relative">
            {/* Left Button */}
            <button
              className="actor-movies-prev absolute -left-12 top-1/2 -translate-y-1/2 z-20
            ...
            {/* Right Button */}
            <button
              className="actor-movies-next absolute -right-12 top-1/2 -translate-y-1/2 z-20
                bg-white text-black w-10 h-10 rounded-full flex items-center
                justify-center shadow-lg hover:scale-110 transition"
            >
              ❯
